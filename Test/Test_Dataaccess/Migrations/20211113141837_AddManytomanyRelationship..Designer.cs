...
namespace Test_Dataaccess.Migrations
{
    ...
    [Migration("20211113141837_AddManytomanyRelationship.")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test_Model.Models.FluentAPI.Fluent_Category", b =>
                {
                    b.Property<int>("Categoru_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Test_Model.Models.FluentAPI.Fluent_Book", b =>
                {
                    b.HasOne("Test_Model.Models.FluentAPI.Fluent_BookDetails", "Fluent_BookDetail")
                        .WithOne("Fluent_Book")
                        .HasForeignKey("Test_Model.Models.FluentAPI.Fluent_Book", "BookDetail_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Test_Model.Models.FluentAPI.Fluent_Publisher", "Fluent_Publisher")
            ...
            modelBuilder.Entity("Test_Model.Models.FluentAPI.Fluent_BookinAuthor", b =>
                {
                    b.HasOne("Test_Model.Models.FluentAPI.Fluenr_Author", "Fluenr_Author")
                        .WithMany("Fluent_BookinAuthors")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Test_Model.Models.FluentAPI.Fluent_Book", "Fluent_Book")
                        .WithMany("Fluent_BookinAuthors")
                        .HasForeignKey("Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Fluenr_Author");
            ...
            modelBuilder.Entity("Test_Model.Models.FluentAPI.Fluenr_Author", b =>
                {
                    b.Navigation("Fluent_BookinAuthors");
                });
